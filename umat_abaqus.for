...
! This is current as of Abaqus 2022. 
...
!  The file aba_param.inc has a line "implicit real*8" and, since 
!  it is included in the main subroutine, it will define the variables
!  there as double precision.  But other subroutines still need the
!  definition "implicit real*8" since there may be variables that are
!  not passed to them through the list or common block.
